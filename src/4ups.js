...
const quadChartData = [
    {
        date: "2024-4-16 - 2024-4-23",
        progressList: [
            "UI is approaching completion",
            "LUT exporting",
            "Poster and Video Complete"
        ],
        risksList: [
            "Artifacts take time from development"
        ],
        plansList: [
            "Final artifacts - Presentation, Technical report",
            "Final product release",
            "Solve issues concerning TIFF file support"
        ],
        needsList: [
            "None"
        ]
    },
    {
        ...
        plansList: [
            "Final artifacts - Video / Poster / Technical report",
            "Final product release",
            "Solve issues concerning TIFF file support"
        ],
        needsList: [
    ...
    {
        date: "2024-4-2 - 2024-4-9",
        progressList: [
            "Preliminary LUT exporting",
            "Work on UI",
            "Bit depth issues fixed"
        ],
        risksList: [
            "Deadline pressure"
        ],
        plansList: [
            ...
            "Completion of LUT exporting",
            "Implementing LogC4->LogC3 conversion formula",
            "Automated integration testing and test report generation"
        ],
        needsList: [
            "C4 -> C3 conversion LUT formulas"
        ]
    },
    {
        date: "2024-3-26 - 2024-4-2",
        progressList: [
            "Saturation bugs fixed",
            "Preparation for LUT exporting",
            "Work on UI"
        ],
        risksList: [
            "Deadline pressure"
        ...
        plansList: [
            ...
            "Fix bit depth limitation with image exporting",
            "Full vertical integration",
            "Automated integration testing and test report generation"
        ],
        needsList: [
            "C4 -> C3 conversion LUT"
        ]
    },
    {
